...
// Profile Routes (Authenticated User) - MUST be before /:id routes
...
router.delete('/data', auth, userController.deleteUserData);
...
router.get('/llm-config', auth, userController.getUserLlmConfig);
router.put('/llm-config', auth, userController.updateUserLlmConfig);

// Admin Routes - MUST be after specific routes to avoid /:id matching /me, /avatar, etc.
