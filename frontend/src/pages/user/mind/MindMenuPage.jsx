        ...
        <div className="w-full h-full flex flex-col items-center bg-black text-white overflow-hidden">
            ...
            <header className="w-full flex items-center justify-between p-4 absolute top-0 left-0 z-20">
                ...
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-white/70 hover:text-white transition-all backdrop-blur-sm border border-white/5"
                >
