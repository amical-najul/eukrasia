            ...
            <div className="space-y-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full max-w-md px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-600 focus:border-blue-600 dark:bg-slate-700 dark:border-slate-600 dark:text-white"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="1.0.0"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-600 focus:border-blue-600 dark:bg-slate-700 dark:border-slate-600 dark:text-white"
                        />
                    </div>
                </div>
